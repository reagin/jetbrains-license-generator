...
export function PageMain() {
  ...
  return (
    <main className='relative grid grid-cols-[repeat(auto-fill,minmax(min(20rem,100%),1fr))] content-center justify-items-center gap-12 bg-background px-8 py-10 text-foreground'>
